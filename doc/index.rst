...
* Get JSON-formatted lists of a site's datasets, groups or other CKAN objects:
  ...
  http://data.ca.gov/api/3/action/package_list

  http://data.ca.gov/api/3/action/group_list

  http://data.ca.gov/api/3/action/tag_list

* Get a full JSON representation of a dataset, resource or other object:

  http://data.ca.gov/api/3/action/package_show?id=adur_district_spending

  http://data.ca.gov/api/3/action/tag_show?id=gold

  http://data.ca.gov/api/3/action/group_show?id=data-explorer

* Search for packages or resources matching a query:

  http://data.ca.gov/api/3/action/package_search?q=spending

  http://data.ca.gov/api/3/action/resource_search?query=name:District%20Names
...
* Get an activity stream of recently changed datasets on a site:
  ...
  http://data.ca.gov/api/3/action/recently_changed_packages_activity_list
...
of all the datasets in the ``data-explorer`` group on data.ca.gov, install
curl and then call the ``group_list`` API function by running this command
in a terminal::

    curl https://data.ca.gov/api/3/action/group_list
...
with this Python code::
    ...
    response = urllib2.urlopen('http://data.ca.gov/api/3/action/group_list',
            data_string)
...
version number, CKAN will choose the latest version of the API::
    ...
    http://data.ca.gov/api/action/package_list
...
``markw`` on data.ca.gov using curl, run this command::

    curl -H "Authorization: XXX"  https://data.ca.gov/api/3/action/am_following_user?id=markw

(Replacing ``XXX`` with your API token.)

Or, to get the list of activities from your user dashboard on data.ca.gov,
run this Python code::

    request = urllib2.Request('https://data.ca.gov/api/3/action/dashboard_activity_list')
...
data.ca.gov, open this URL in your browser:

http://data.ca.gov/api/3/action/package_list

Or, to search for datasets (packages) matching the search query ``spending``,
on data.ca.gov, open this URL in your browser:
...
http://data.ca.gov/api/3/action/package_search?q=spending&rows=10
...
http://data.ca.gov/api/3/action/term_translation_show?terms=russian&terms=romantic%20novel
...
http://data.ca.gov/api/3/action/package_show?id=adur_district_spending&callback=myfunction
...
* browser: http://data.ca.gov/api/3/action/tag_list
* curl: ``curl http://data.ca.gov/api/3/action/tag_list``
* ckanapi: ``ckanapi -r http://data.ca.gov action tag_list``

Top 10 tags used by datasets:

* browser: http://data.ca.gov/api/action/package_search?facet.field=[%22tags%22]&facet.limit=10&rows=0
* curl: ``curl 'http://data.ca.gov/api/action/package_search?facet.field=\["tags"\]&facet.limit=10&rows=0'``
* ckanapi: ``ckanapi -r http://data.ca.gov action package_search facet.field='["tags"]' facet.limit=10 rows=0``

All datasets that have tag 'economy':

* browser: http://data.ca.gov/api/3/action/package_search?fq=tags:economy
* curl: ``curl 'http://data.ca.gov/api/3/action/package_search?fq=tags:economy'``
* ckanapi: ``ckanapi -r http://data.ca.gov action package_search fq='tags:economy'``
...
request, with curl you can do this using the ``@file.csv``::
    ...
    curl -X POST  -H "Content-Type: multipart/form-data"  -H "Authorization: XXXX"  -F "id=<resource_id>" -F "upload=@updated_file.csv" https://data.ca.gov/api/3/action/resource_patch
