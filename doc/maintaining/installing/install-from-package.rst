...
.. tip::
   ...
   |/path/to/ckan.ini| file to reference your |postgres| server.
...
Edit the :ref:`sqlalchemy.url` option in your :ref:`config_file` (|/path/to/ckan.ini|) file and
...
.. tip::
   ...
   |/path/to/ckan.ini| file to reference your |solr| server.
...
#. Edit the :ref:`config_file` (|/path/to/ckan.ini|) to set up the following options:
