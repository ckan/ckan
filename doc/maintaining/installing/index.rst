...
CKAN 2.10 supports Python 3.10 and Python 3.11.
...
* You want to install CKAN on an Ubuntu 22.04, 64-bit server, *and*
...
* You want to install CKAN on a different version of Ubuntu, not 22.04, *or*
