...
def get_flashed_messages(with_categories: bool = True,        # type: ignore
    ...
    with_categories : bool
        If True, return messages with their categories.
        If False, return only the messages.
    args
        Additional positional arguments passed to Flask's get_flashed_messages.
    kwargs
        Additional keyword arguments passed to Flask's get_flashed_messages.

    Returns
    -------
    list
        A list of flashed messages. If with_categories is True, each
