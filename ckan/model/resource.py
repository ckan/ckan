...
resource_table = Table(
    ...
    Column('url', types.UnicodeText, nullable=False, doc='from_dict'),
    Column('format', types.UnicodeText),  # XXX: doc='from_dict' makes lots of tests fail, fix tests?
    Column('description', types.UnicodeText, doc='from_dict'),
    Column('hash', types.UnicodeText),
    Column('position', types.Integer),

    Column('name', types.UnicodeText, doc='from_dict'),
    Column('resource_type', types.UnicodeText, doc='from_dict'),
    Column('mimetype', types.UnicodeText, doc='from_dict'),
    Column('mimetype_inner', types.UnicodeText, doc='from_dict'),
