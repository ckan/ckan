...
package_table = Table('package', meta.metadata,
        ...
        Column('name', types.Unicode(PACKAGE_NAME_MAX_LENGTH),
               nullable=False, unique=True, doc='update'),
        Column('title', types.UnicodeText, doc='update'),
        Column('version', types.Unicode(PACKAGE_VERSION_MAX_LENGTH), doc='update'),
        Column('url', types.UnicodeText, doc='update'),
        Column('author', types.UnicodeText, doc='update'),
        Column('author_email', types.UnicodeText, doc='update'),
        Column('maintainer', types.UnicodeText, doc='update'),
        Column('maintainer_email', types.UnicodeText, doc='update'),
        Column('notes', types.UnicodeText, doc='update'),
        Column('license_id', types.UnicodeText, doc='update'),
