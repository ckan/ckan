...
package_table = Table('package', meta.metadata,
        ...
        Column('title', types.UnicodeText, doc='from_dict'),
        Column('version', types.Unicode(PACKAGE_VERSION_MAX_LENGTH), doc='from_dict'),
        Column('url', types.UnicodeText, doc='from_dict'),
        Column('author', types.UnicodeText, doc='from_dict'),
        Column('author_email', types.UnicodeText, doc='from_dict'),
        Column('maintainer', types.UnicodeText, doc='from_dict'),
        Column('maintainer_email', types.UnicodeText, doc='from_dict'),
        Column('notes', types.UnicodeText, doc='from_dict'),
        Column('license_id', types.UnicodeText, doc='from_dict'),
