...
from ckan.tests_legacy import TestController, CreateTestData, setup_test_search_index
from ckan.tests_legacy.lib import check_search_results
...
class TestGeographicCoverage(TestController):
    ...
    def test_1_filtered(self):
        ...
        from ckan.tests_legacy import SkipTest
        raise SkipTest
