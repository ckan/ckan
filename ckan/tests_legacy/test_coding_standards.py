...
class TestImportStar(object):
    ...
    IMPORT_STAR_BLACKLIST_FILES = [
        ...
        'ckan/tests_legacy/functional/api/base.py',
        'ckan/tests_legacy/functional/api/test_api.py',
        'ckan/tests_legacy/functional/api/test_misc.py',
        'ckan/tests_legacy/functional/api/test_package_search.py',
        'ckan/tests_legacy/functional/api/test_resource_search.py',
        'ckan/tests_legacy/functional/api/test_revision_search.py',
        'ckan/tests_legacy/functional/test_group.py',
        'ckan/tests_legacy/functional/test_home.py',
        'ckan/tests_legacy/functional/test_package.py',
        'ckan/tests_legacy/functional/test_package_relationships.py',
        'ckan/tests_legacy/functional/test_tag.py',
        'ckan/tests_legacy/lib/test_alphabet_pagination.py',
        'ckan/tests_legacy/lib/test_helpers.py',
        'ckan/tests_legacy/lib/test_resource_search.py',
        'ckan/tests_legacy/lib/test_tag_search.py',
        'ckan/tests_legacy/misc/test_sync.py',
        'ckan/tests_legacy/models/test_extras.py',
        'ckan/tests_legacy/models/test_misc.py',
        'ckan/tests_legacy/models/test_package.py',
        'ckan/tests_legacy/models/test_package_relationships.py',
        'ckan/tests_legacy/models/test_purge_revision.py',
        'ckan/tests_legacy/models/test_resource.py',
        'ckan/tests_legacy/models/test_revision.py',
        'ckan/tests_legacy/models/test_user.py',
        'ckan/tests_legacy/pylons_controller.py',
        'ckan/tests_legacy/test_dumper.py',
        'ckan/tests_legacy/test_wsgi_ckanclient.py',
        'fabfile.py',
    ]
    fails = {}
    passes = []
...
class TestPep8(object):
    ...
    PEP8_BLACKLIST_FILES = [
        ...
        'ckan/tests_legacy/__init__.py',
        'ckan/tests_legacy/ckantestplugin/ckantestplugin/__init__.py',
        'ckan/tests_legacy/ckantestplugin/setup.py',
        'ckan/tests_legacy/ckantestplugins.py',
        'ckan/tests_legacy/functional/api/base.py',
        'ckan/tests_legacy/functional/api/model/test_group.py',
        'ckan/tests_legacy/functional/api/model/test_licenses.py',
        'ckan/tests_legacy/functional/api/model/test_package.py',
        'ckan/tests_legacy/functional/api/model/test_ratings.py',
        'ckan/tests_legacy/functional/api/model/test_relationships.py',
        'ckan/tests_legacy/functional/api/model/test_revisions.py',
        'ckan/tests_legacy/functional/api/model/test_tag.py',
        'ckan/tests_legacy/functional/api/model/test_vocabulary.py',
        'ckan/tests_legacy/functional/api/test_activity.py',
        'ckan/tests_legacy/functional/api/test_api.py',
        'ckan/tests_legacy/functional/api/test_dashboard.py',
        'ckan/tests_legacy/functional/api/test_email_notifications.py',
        'ckan/tests_legacy/functional/api/test_follow.py',
        'ckan/tests_legacy/functional/api/test_misc.py',
        'ckan/tests_legacy/functional/api/test_package_search.py',
        'ckan/tests_legacy/functional/api/test_resource.py',
        'ckan/tests_legacy/functional/api/test_resource_search.py',
        'ckan/tests_legacy/functional/api/test_revision_search.py',
        'ckan/tests_legacy/functional/api/test_user.py',
        'ckan/tests_legacy/functional/api/test_util.py',
        'ckan/tests_legacy/functional/base.py',
        'ckan/tests_legacy/functional/test_activity.py',
        'ckan/tests_legacy/functional/test_admin.py',
        'ckan/tests_legacy/functional/test_cors.py',
        'ckan/tests_legacy/functional/test_error.py',
        'ckan/tests_legacy/functional/test_home.py',
        'ckan/tests_legacy/functional/test_package.py',
        'ckan/tests_legacy/functional/test_package_relationships.py',
        'ckan/tests_legacy/functional/test_pagination.py',
        'ckan/tests_legacy/functional/test_preview_interface.py',
        'ckan/tests_legacy/functional/test_related.py',
        'ckan/tests_legacy/functional/test_revision.py',
        'ckan/tests_legacy/functional/test_search.py',
        'ckan/tests_legacy/functional/test_storage.py',
        'ckan/tests_legacy/functional/test_tag.py',
        'ckan/tests_legacy/functional/test_tag_vocab.py',
        'ckan/tests_legacy/functional/test_upload.py',
        'ckan/tests_legacy/functional/test_user.py',
        'ckan/tests_legacy/html_check.py',
        'ckan/tests_legacy/lib/__init__.py',
        'ckan/tests_legacy/lib/test_accept.py',
        'ckan/tests_legacy/lib/test_alphabet_pagination.py',
        'ckan/tests_legacy/lib/test_cli.py',
        'ckan/tests_legacy/lib/test_dictization.py',
        'ckan/tests_legacy/lib/test_email_notifications.py',
        'ckan/tests_legacy/lib/test_hash.py',
        'ckan/tests_legacy/lib/test_helpers.py',
        'ckan/tests_legacy/lib/test_i18n.py',
        'ckan/tests_legacy/lib/test_mailer.py',
        'ckan/tests_legacy/lib/test_munge.py',
        'ckan/tests_legacy/lib/test_navl.py',
        'ckan/tests_legacy/lib/test_resource_search.py',
        'ckan/tests_legacy/lib/test_simple_search.py',
        'ckan/tests_legacy/lib/test_solr_package_search.py',
        'ckan/tests_legacy/lib/test_solr_package_search_synchronous_update.py',
        'ckan/tests_legacy/lib/test_solr_schema_version.py',
        'ckan/tests_legacy/lib/test_solr_search_index.py',
        'ckan/tests_legacy/lib/test_tag_search.py',
        'ckan/tests_legacy/logic/test_action.py',
        'ckan/tests_legacy/logic/test_auth.py',
        'ckan/tests_legacy/logic/test_tag.py',
        'ckan/tests_legacy/logic/test_validators.py',
        'ckan/tests_legacy/misc/test_format_text.py',
        'ckan/tests_legacy/misc/test_mock_mail_server.py',
        'ckan/tests_legacy/misc/test_sync.py',
        'ckan/tests_legacy/mock_mail_server.py',
        'ckan/tests_legacy/mock_plugin.py',
        'ckan/tests_legacy/models/test_extras.py',
        'ckan/tests_legacy/models/test_group.py',
        'ckan/tests_legacy/models/test_license.py',
        'ckan/tests_legacy/models/test_misc.py',
        'ckan/tests_legacy/models/test_package.py',
        'ckan/tests_legacy/models/test_package_relationships.py',
        'ckan/tests_legacy/models/test_purge_revision.py',
        ...
        'ckan/tests_legacy/models/test_revision.py',
        'ckan/tests_legacy/models/test_user.py',
        'ckan/tests_legacy/monkey.py',
        'ckan/tests_legacy/pylons_controller.py',
        'ckan/tests_legacy/schema/test_schema.py',
        'ckan/tests_legacy/test_dumper.py',
        'ckan/tests_legacy/test_plugins.py',
        'ckan/tests_legacy/test_versions.py',
        'ckan/tests_legacy/test_wsgi_ckanclient.py',
        'ckan/tests_legacy/wsgi_ckanclient.py',
        'ckan/websetup.py',
