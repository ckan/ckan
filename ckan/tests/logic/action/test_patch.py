...
class TestPatch(object):
    ...
    def test_package_patch_updating_single_field(self):
        user = factories.User()
        dataset = factories.Dataset(name="annakarenina",
                                    notes="some test now",
                                    user=user)
    ...
    def test_resource_patch_updating_single_field(self):
        ...
        resource = helpers.call_action("resource_patch",
    ...
    def test_group_patch_preserve_datasets(self):
        ...
        group = helpers.call_action("group_patch",
                                    id=group["id"],
                                    context={"user": user["name"]})
        ...
        group4 = helpers.call_action("group_show",
                                     id=group["id"],
