...
@pytest.mark.usefixtures(u"clean_db")
def test_package_show__deleted_dataset_is_hidden_to_public():
...
@pytest.mark.usefixtures(u"clean_db")
def test_package_show__deleted_dataset_is_visible_to_editor():
...
@pytest.mark.usefixtures(u"clean_db")
def test_group_show__deleted_group_is_hidden_to_public():
...
@pytest.mark.usefixtures(u"clean_db")
def test_group_show__deleted_group_is_visible_to_its_member():
...
@pytest.mark.usefixtures(u"clean_db")
def test_group_show__deleted_org_is_visible_to_its_member():
...
@pytest.mark.ckan_config(u"ckan.auth.public_user_details", u"false")
@pytest.mark.usefixtures(u"clean_db")
def test_group_show__user_is_hidden_to_public():
...
@pytest.mark.usefixtures(u"clean_db")
def test_group_show__user_is_avail_to_public():
    group = factories.Group()
    context = {"model": model}
    context["user"] = ""
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_show_anon_user():
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_show_normal_user():
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_show_sysadmin():
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_list_anon_user():
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_list_normal_user():
...
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_list_sysadmin():
...
@pytest.mark.ckan_config(u"ckan.auth.public_activity_stream_detail", u"false")
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_public_activity_stream_detail_denied():
...
@pytest.mark.ckan_config(u"ckan.auth.public_activity_stream_detail", u"true")
@pytest.mark.usefixtures(u"clean_db")
def test_config_option_public_activity_stream_detail():
