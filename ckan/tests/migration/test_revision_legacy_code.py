...
def test_09_package_alter():
    ...
    # for comparison
    clean_package_dictized = remove_changable_columns(package_dictized)
    ...
    # def test_13_get_package_in_past():
...
def remove_changable_columns(dict, remove_package_id=False):
