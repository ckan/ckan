...
class TestHelpersUrlFor(object):
    ...
    @helpers.change_config('ckan.site_url', 'http://example.com')
    @helpers.change_config('ckan.root_path', '')
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_with_locale(self):
        url = '/fr/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
                                  locale='fr')
    ...
    @helpers.change_config('ckan.site_url', 'http://example.com')
    @helpers.change_config('ckan.root_path', '/my/prefix/{{LANG}}')
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_qualified_with_locale_offered(self):
        url = 'http://example.com/fr/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
                                  qualified=True,
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_qualified_with_locale_not_offered(self):
        url = 'http://example.com/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
    ...
    def test_url_for_qualified_with_root_path_and_locale(self):
        url = 'http://example.com/my/custom/path/fr/foo/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
                                  qualified=True,
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_not_qual_without_root_path_and_locale_with_no_root(self):
        url = '/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_qualified_without_root_path_and_locale_with_no_root(self):
        url = 'http://example.com/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_not_qualified_without_root_path_with_locale_no_root(self):
        url = '/fr/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_qualified_without_root_path_with_locale_no_root(self):
        url = 'http://example.com/fr/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_not_qualified_with_root_path_locale_no_root(self):
        url = '/my/custom/path/fr/foo/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
                                  qualified=False,
    ...
    @helpers.change_config('ckan.locale_order', 'en fr')
    @helpers.change_config('ckan.locales_offered', 'en fr')
    def test_url_for_qualified_with_root_path_and_locale_no_root(self):
        url = 'http://example.com/my/custom/path/fr/foo/dataset/my_dataset'
        generated_url = h.url_for(controller='package',
                                  action='read',
                                  id='my_dataset',
