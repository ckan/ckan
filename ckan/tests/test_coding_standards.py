...
_STRING_LITERALS_WHITELIST = [
    ...
    u'ckanext/example_theme/custom_config_setting/plugin.py',
    u'ckanext/example_theme/custom_emails/plugin.py',
    u'ckanext/example_theme/custom_emails/tests.py',
    u'ckanext/example_theme/v01_empty_extension/plugin.py',
    u'ckanext/example_theme/v02_empty_template/plugin.py',
    u'ckanext/example_theme/v03_jinja/plugin.py',
    u'ckanext/example_theme/v04_ckan_extends/plugin.py',
    u'ckanext/example_theme/v05_block/plugin.py',
    u'ckanext/example_theme/v06_super/plugin.py',
    u'ckanext/example_theme/v07_helper_function/plugin.py',
    u'ckanext/example_theme/v08_custom_helper_function/plugin.py',
    u'ckanext/example_theme/v09_snippet/plugin.py',
    u'ckanext/example_theme/v10_custom_snippet/plugin.py',
    u'ckanext/example_theme/v11_HTML_and_CSS/plugin.py',
    u'ckanext/example_theme/v12_extra_public_dir/plugin.py',
    u'ckanext/example_theme/v13_custom_css/plugin.py',
    u'ckanext/example_theme/v14_more_custom_css/plugin.py',
    u'ckanext/example_theme/v15_fanstatic/plugin.py',
    u'ckanext/example_theme/v16_initialize_a_javascript_module/plugin.py',
    u'ckanext/example_theme/v17_popover/plugin.py',
    u'ckanext/example_theme/v18_snippet_api/plugin.py',
    u'ckanext/example_theme/v19_01_error/plugin.py',
    u'ckanext/example_theme/v19_02_error_handling/plugin.py',
    u'ckanext/example_theme/v20_pubsub/plugin.py',
    u'ckanext/example_theme/v21_custom_jquery_plugin/plugin.py',
