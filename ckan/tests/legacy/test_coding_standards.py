...
class TestPep8(object):
    ...
    PEP8_BLACKLIST_FILES = [
        ...
        'ckan/lib/markdown/blockparser.py',
        'ckan/lib/markdown/blockprocessors.py',
        'ckan/lib/markdown/__init__.py',
        'ckan/lib/markdown/inlinepatterns.py',
        'ckan/lib/markdown/__main__.py',
        'ckan/lib/markdown/odict.py',
        'ckan/lib/markdown/postprocessors.py',
        'ckan/lib/markdown/preprocessors.py',
        'ckan/lib/markdown/serializers.py',
        'ckan/lib/markdown/treeprocessors.py',
        'ckan/lib/markdown/util.py',
        'ckan/lib/markdown/__version__.py',
        'ckan/lib/markdown/extensions/abbr.py',
        'ckan/lib/markdown/extensions/admonition.py',
        'ckan/lib/markdown/extensions/attr_list.py',
        'ckan/lib/markdown/extensions/codehilite.py',
        'ckan/lib/markdown/extensions/def_list.py',
        'ckan/lib/markdown/extensions/fenced_code.py',
        'ckan/lib/markdown/extensions/footnotes.py',
        'ckan/lib/markdown/extensions/headerid.py',
        'ckan/lib/markdown/extensions/__init__.py',
        'ckan/lib/markdown/extensions/meta.py',
        'ckan/lib/markdown/extensions/nl2br.py',
        'ckan/lib/markdown/extensions/sane_lists.py',
        'ckan/lib/markdown/extensions/smart_strong.py',
        'ckan/lib/markdown/extensions/smarty.py',
        'ckan/lib/markdown/extensions/tables.py',
        'ckan/lib/markdown/extensions/toc.py',
        'ckan/lib/markdown/extensions/wikilinks.py',
