...
class TestImportStar(object):
    ...
    IMPORT_STAR_BLACKLIST_FILES = [
        ...
        u'ckan/tests/legacy/functional/api/test_revision_search.py',
        u'ckan/tests/legacy/functional/test_group.py',
        u'ckan/tests/legacy/functional/test_home.py',
        u'ckan/tests/legacy/functional/test_package.py',
        u'ckan/tests/legacy/functional/test_package_relationships.py',
