...
class TestNotification(TestController):
    ...
    def test_edit_package_tags(self):
        # edit package
        new_tag = u'new'
        rev = model.repo.new_revision()
    ...
    def test_add_package_group(self):
        # edit package
    ...
    def test_remove_package_group(self):
        # edit package
        new_tag = u'new'
        rev = model.repo.new_revision()
    ...
    def test_add_package_extra(self):
        # edit package
        rev = model.repo.new_revision()
    ...
    def test_edit_package_extra(self):
        raise NotImplementedError()

    def test_remove_package_extra(self):
        raise NotImplementedError()
        
    def test_add_package_resource(self):
        raise NotImplementedError()

    def test_edit_package_resource(self):
        raise NotImplementedError()

    def test_remove_package_resource(self):
        raise NotImplementedError()
