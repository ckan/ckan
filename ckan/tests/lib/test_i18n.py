...
class TestI18nFlaskAndPylons(object):
    ...
    def test_i18n_directory(self):
        orig_i18n_directory = config.get("ckan.i18n_directory")
        config["ckan.i18n_directory"] = I18N_DUMMY_DIR
        ...
        try:
            ...
            if orig_i18n_directory is None:
                del config["ckan.i18n_directory"]
            else:
                config["ckan.i18n_directory"] = orig_i18n_directory
