...
#        assert pkg1.extras['precision'] == val, pkg1.extras
        ...
        assert pkg2.download_url == 'http://www.dcsf.gov.uk/rsgateway/DB/SFR/s000848/SFR11_2009tables.xls', pkg2.download_url
#        assert pkg2.resources[0].url == 'http://www.dcsf.gov.uk/rsgateway/DB/SFR/s000848/SFR11_2009tables.xls', pkg2.resources
        assert not pkg1.download_url, pkg1.download_url
#        assert pkg1.resources == [], pkg1.resources
        assert not pkg3.download_url, pkg3.download_url
