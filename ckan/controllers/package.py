...
class PackageController(base.BaseController):
    ...
    def new_raw(self, data=None, errors=None, error_summary=None):
    ...
    def new_semantic(self, data=None, errors=None, error_summary=None):
        package_type = self._guess_package_type(True)
    ...
    def _save_new(self, context, package_type=None):
        ...
        try:
            ...
            return self.new_raw(data_dict, errors, error_summary)
