...
def changes(id, group_type, is_organization):
    ...
    current_group_dict = get_action(u'group_show')(context, {u'id': group_id})
    group_activity_list = get_action(u'group_activity_list')(
        context, {
            u'id': group_id,
            u'limit': 100
        }
...
def changes_multiple(is_organization, group_type=None):
    ...
    current_group_dict = get_action(u'group_show')(context, {u'id': group_id})
    group_activity_list = get_action(u'group_activity_list')(context, {
        u'id': group_id,
        u'limit': 100})
