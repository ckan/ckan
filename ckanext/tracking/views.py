...
Flask must have a registered route for that path or it
returns 405 before middleware runs.
...
tracking_bp.add_url_rule("/_tracking", "tracking", tracking_endpoint, methods=["POST"])
