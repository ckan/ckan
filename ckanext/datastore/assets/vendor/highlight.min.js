...
const E="[a-zA-Z]\\w*",y="[a-zA-Z_]\\w*",_="\\b\\d+(\\.\\d+)?",w="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",v="\\b(0b[01]+)",x={
...
},k=A("//","$"),R=A("/\\*","\\*/"),O=A("#","$");var M=Object.freeze({
__proto__:null,MATCH_NOTHING_RE:/\b\B/,IDENT_RE:E,UNDERSCORE_IDENT_RE:y,
NUMBER_RE:_,C_NUMBER_RE:w,BINARY_NUMBER_RE:v,
RE_STARTERS_RE:"!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",
SHEBANG:(e={})=>{const n=/^#![ ]*\//
;return e.binary&&(e.begin=h(n,/.*\b/,e.binary,/\b.*/)),s({scope:"meta",begin:n,
end:/$/,relevance:0,"on:begin":(e,n)=>{0!==e.index&&n.ignoreMatch()}},e)},
BACKSLASH_ESCAPE:x,APOS_STRING_MODE:S,QUOTE_STRING_MODE:N,PHRASAL_WORDS_MODE:{
begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/
},COMMENT:A,C_LINE_COMMENT_MODE:k,C_BLOCK_COMMENT_MODE:R,HASH_COMMENT_MODE:O,
...
contains:[x]}]}]},TITLE_MODE:{scope:"title",begin:E,relevance:0},
UNDERSCORE_TITLE_MODE:{scope:"title",begin:y,relevance:0},METHOD_GUARD:{
begin:"\\.\\s*"+y,relevance:0},END_SAME_AS_BEGIN:e=>Object.assign(e,{
...
;function z(e,n,t=P){const s=Object.create(null)
...
;[T,j,X,$].forEach((e=>e(i,r))),e.compilerExtensions.forEach((e=>e(i,r))),
...
;return r.code=i.code,A("after:highlight",r),r}function E(e,t,a,i){
const c=Object.create(null);function l(){if(!A.keywords)return void R.addText(O)
;let e=0;A.keywordPatternRe.lastIndex=0;let n=A.keywordPatternRe.exec(O),t=""
;for(;n;){t+=O.substring(e,n.index)
;const a=v.case_insensitive?n[0].toLowerCase():n[0],i=(s=a,A.keywords[s]);if(i){
const[e,s]=i
;if(R.addText(t),t="",c[a]=(c[a]||0)+1,c[a]<=7&&(M+=s),e.startsWith("_"))t+=n[0];else{
const t=v.classNameAliases[e]||e;d(n[0],t)}}else t+=n[0]
;e=A.keywordPatternRe.lastIndex,n=A.keywordPatternRe.exec(O)}var s
;t+=O.substring(e),R.addText(t)}function g(){null!=A.subLanguage?(()=>{
if(""===O)return;let e=null;if("string"==typeof A.subLanguage){
if(!s[A.subLanguage])return void R.addText(O)
;e=E(A.subLanguage,O,!0,k[A.subLanguage]),k[A.subLanguage]=e._top
}else e=y(O,A.subLanguage.length?A.subLanguage:null)
;A.relevance>0&&(M+=e.relevance),R.__addSublanguage(e._emitter,e.language)
})():l(),O=""}function d(e,n){
...
O=""):e.beginScope._multi&&(u(e.beginScope,n),O="")),A=Object.create(e,{parent:{
value:A}}),A}function p(e,t,s){let a=((e,n)=>{const t=e&&e.exec(n)
...
return 0===A.matcher.regexIndex?(O+=e[0],1):(I=!0,0)}function f(e){
const n=e[0],s=t.substring(e.index),a=p(A,e,s);if(!a)return ee;const i=A
;A.endScope&&A.endScope._wrap?(g(),
d(n,A.endScope._wrap)):A.endScope&&A.endScope._multi?(g(),
u(A.endScope,e)):i.skip?O+=n:(i.returnEnd||i.excludeEnd||(O+=n),
g(),i.excludeEnd&&(O=n));do{
A.scope&&R.closeNode(),A.skip||A.subLanguage||(M+=A.relevance),A=A.parent
}while(A!==a.parent);return a.starts&&h(a.starts,e),i.returnEnd?0:n.length}
let _={};function w(s,i){const o=i&&i[0];if(O+=s,null==o)return g(),0
...
;return O+=o,o.length}const v=x(e)
;if(!v)throw F(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const S=q(v);let N="",A=i||S;const k={},R=new b.__emitter(b);(()=>{const e=[]
;for(let n=A;n!==v;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>R.openNode(e)))})();let O="",M=0,B=0,T=0,I=!1;try{
if(v.__emitTokens)v.__emitTokens(t,R);else{for(A.matcher.considerAll();;){
T++,I?I=!1:A.matcher.considerAll(),A.matcher.lastIndex=B
;const e=A.matcher.exec(t);if(!e)break;const n=w(t.substring(B,e.index),e)
;B=e.index+n}w(t.substring(B))}return R.finalize(),N=R.toHTML(),{language:e,
value:N,relevance:M,illegal:!1,_emitter:R,_top:A}}catch(n){
...
language:e,value:Q(t),illegal:!1,relevance:0,errorRaised:n,_emitter:R,_top:A}
;throw n}}function y(e,n){n=n||b.languages||Object.keys(s);const t=(e=>{
const n={value:Q(e),illegal:!1,relevance:0,_top:l,_emitter:new b.__emitter(b)}
;return n._emitter.addText(e),n})(e),a=n.filter(x).filter(N).map((n=>E(n,e,!1)))
...
;const t=b.languageDetectRe.exec(n);if(t){const n=x(t[1])
...
;n=e;const s=n.textContent,i=t?f(s,{language:t,ignoreIllegals:!0}):y(s)
...
}),A("after:highlightElement",{el:e,result:i,text:s})}let w=!1;function v(){
"loading"!==document.readyState?document.querySelectorAll(b.cssSelector).forEach(_):w=!0
}function x(e){return e=(e||"").toLowerCase(),s[e]||s[a[e]]}
function S(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{
a[e.toLowerCase()]=n}))}function N(e){const n=x(e)
;return n&&!n.disableAutodetect}function A(e,n){const t=e;i.forEach((e=>{
e[t]&&e[t](n)}))}
"undefined"!=typeof window&&window.addEventListener&&window.addEventListener("DOMContentLoaded",(()=>{
w&&v()}),!1),Object.assign(t,{highlight:f,highlightAuto:y,highlightAll:v,
highlightElement:_,
highlightBlock:e=>(Z("10.7.0","highlightBlock will be removed entirely in v12.0"),
Z("10.7.0","Please use highlightElement now."),_(e)),configure:e=>{b=Y(b,e)},
initHighlighting:()=>{
...
!r)throw n;F(n),a=l}
a.name||(a.name=e),s[e]=a,a.rawDefinition=n.bind(null,t),a.aliases&&S(a.aliases,{
languageName:e})},unregisterLanguage:e=>{delete s[e]
;for(const n of Object.keys(a))a[n]===e&&delete a[n]},
listLanguages:()=>Object.keys(s),getLanguage:x,registerAliases:S,
...
excludeBegin:!0,excludeEnd:!0,keywords:a,contains:f},y={variants:[{
...
className:"title.function",relevance:0};var x;const S={
...
PARAMS_CONTAINS:f,CLASS_REFERENCE:_},illegal:/#(?![$_A-z])/,
contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),{
label:"use_strict",className:"meta",relevance:10,
begin:/^\s*['"]use (strict|asm)['"]/
},e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,g,d,u,h,p,{match:/\$\d+/},c,_,{
...
className:"title.function"})]},{match:/\.\.\./,relevance:0},S,{match:"\\$"+t,
relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},
contains:[E]},v,{relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,
className:"variable.constant"},y,N,{match:/\$[(.]/}]}},grmr_bash:e=>{
...
;const he=se;for(const e of Object.keys(ue)){
