...
self.el[0].innerHTML=highlighted;},error:function(jqXHR,textStatus,errorThrown){if(textStatus=="error"&&jqXHR.responseText){self.el.html(jqXHR.responseText);}else{self.el.html(self.i18n("An error occured during AJAX request. Could not load view."));}}});}};});