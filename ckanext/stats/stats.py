    ...
    def most_edited_packages(cls, limit=10):
        ...
        s = select([
            ...
            func.count(package_revision.c.revision_id)
                   ...
                   from_obj=[package_revision.join(package)]).where(
                       and_(
                           package.c.private == False,
                           package.c.state == 'active',
                       )
                   ).group_by(package_revision.c.id).order_by(
...
class RevisionStats(object):
    ...
    def get_new_packages(cls):
        ...
        def new_packages():
            ...
            s = select([package_revision.c.id,
                       ...
                       from_obj=[package_revision.join(revision)]).group_by(
                           package_revision.c.id
    ...
    def get_deleted_packages(cls):
        ...
        def deleted_packages():
            ...
            s = select([package_revision.c.id,
                        func.min(revision.c.timestamp)],
                       from_obj=[package_revision.join(revision)]).where(
    ...
    def get_num_packages_by_week(cls):
        ...
        def num_packages():
            ...
            def build_weekly_stats(
                ...
                return (
                    week_commences.strftime(DATE_FORMAT), num_pkgs,
    ...
    def get_by_week(cls, object_type):
        ...
        def objects_by_week():
            ...
            first_date = get_date(objects[0][1]
            ...
            def build_weekly_stats(week_commences, pkg_ids):
                ...
                cls._cumulative_num_pkgs += num_pkgs
                return (
                    week_commences.strftime(DATE_FORMAT), pkg_ids, num_pkgs,
                    cls._cumulative_num_pkgs
                )
