...
if(label.length>8){label=label.slice(0,5)+"...";}
return label;};var xaxis={};xaxis.tickFormatter=tickFormatter;if(numPoints){var ticks=[],maxTicks=10,x=1,i=0;while(x<=maxTicks){if((numPoints/x)<=maxTicks){break;}
x=x+1;}
