...
entry_points = {
    ...
    'paste.paster_command': [
        'db = ckan.lib.commands.db:ManageDb',
        'create-test-data = ckan.lib.commands.test_data:CreateTestDataCommand',
        'sysadmin = ckan.lib.commands.sysadmin:Sysadmin',
        'user = ckan.lib.commands.user:UserCmd',
        'dataset = ckan.lib.commands.dataset:DatasetCmd',
        'search-index = ckan.lib.commands.search:SearchIndexCommand',
        'ratings = ckan.lib.commands.ratings:Ratings',
        'notify = ckan.lib.commands.notification:Notification',
        'celeryd = ckan.lib.commands.celery:Celery',
        'rdf-export = ckan.lib.commands.rdf:RDFExport',
        'tracking = ckan.lib.commands.tracking:Tracking',
        'plugin-info = ckan.lib.commands.plugin_info:PluginInfo',
        'profile = ckan.lib.commands.profile:Profile',
        'color = ckan.lib.commands.color_scheme:CreateColorSchemeCommand',
        'check-po-files = ckan.i18n.check_po_files:CheckPoFiles',
        'trans = ckan.lib.commands.translations:TranslationsCommand',
        'minify = ckan.lib.commands.minify:MinifyCommand',
        'less = ckan.lib.commands.less:LessCommand',
        'datastore = ckanext.datastore.commands:SetupDatastoreCommand',
        'datapusher = ckanext.datapusher.cli:DatapusherCommand',
        'front-end-build = ckan.lib.commands.front_end:FrontEndBuildCommand',
        'views = ckan.lib.commands.views:ViewsCommand',
        'config-tool = ckan.lib.commands.config:ConfigToolCommand',
    ],
    'console_scripts': [
