...
entry_points = {
    ...
    'ckan.test_plugins': [
        'routes_plugin = tests_legacy.ckantestplugins:RoutesPlugin',
        'mapper_plugin = tests_legacy.ckantestplugins:MapperPlugin',
        'session_plugin = tests_legacy.ckantestplugins:SessionPlugin',
        'mapper_plugin2 = tests_legacy.ckantestplugins:MapperPlugin2',
        'authorizer_plugin = tests_legacy.ckantestplugins:AuthorizerPlugin',
        'test_observer_plugin = tests_legacy.ckantestplugins:PluginObserverPlugin',
        'action_plugin = tests_legacy.ckantestplugins:ActionPlugin',
        'auth_plugin = tests_legacy.ckantestplugins:AuthPlugin',
        'test_group_plugin = tests_legacy.ckantestplugins:MockGroupControllerPlugin',
        'test_package_controller_plugin = tests_legacy.ckantestplugins:MockPackageControllerPlugin',
        'test_resource_preview = tests_legacy.ckantestplugins:MockResourcePreviewExtension',
        'test_json_resource_preview = tests_legacy.ckantestplugins:JsonMockResourcePreviewExtension',
